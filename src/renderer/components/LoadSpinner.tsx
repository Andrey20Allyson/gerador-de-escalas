...
export const LoadSpinner = styled.span<LoadSpinnerProps>`
  ...
  animation-duration: ${({ spinDuration = 1.5 }) =>
    typeof spinDuration === "string" ? spinDuration : `${spinDuration}s`};
  ...
  border-radius: 50%;
  border-style: solid;
  border-width: ${({ spinnerWidth = 2 }) =>
    typeof spinnerWidth === "string" ? spinnerWidth : `${spinnerWidth}px`};
